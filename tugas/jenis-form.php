...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // cek apakah data di tambah atau di update dengan mengecek deskripsi url
    if (isset($_GET['edit'])) {
        $id = $_GET['edit'];
...
if (isset($_GET['edit'])) {
    ...
    $stmt = oci_parse($conn, "SELECT * FROM jenis WHERE id = :id");
    oci_bind_by_name($stmt, ':id', $id);
    oci_execute($stmt);
            ...
            <div class="card-body">
                <form method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="deskripsi" id="deskripsi" rows="3" placeholder="Deskripsi Jenis"><?= $deskripsi ?></textarea>
                    </div>
